...
urlpatterns = [
    ...
    path('humanoid-robot/', views.humanoid_robot, name='humanoid_robot'),
    path('home-automation/', views.home_automation, name='home_automation'),
    path('solar-tracking/', views.solar_tracking, name='solar-tracking'),
    path('obstraction-avoiding-car/', views.obstraction_avoiding_car, name='obstraction_avoiding_car'),
